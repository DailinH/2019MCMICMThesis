...
%$T_{IN}(x,y,t)$& continuous variable, the amount of opoid transported into or produced by location$(x,y)$ at time $t$  \\ \hline
%$T_{OUT}(x,y,t)$&the amount of opoid transported out of location$(x,y)$ at time $t$  \\ \hline
