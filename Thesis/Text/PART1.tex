\subsection{the Continuous Drug Spread Model}
...
%We use $D(\frac{\partial^2 S}{\partial x^2} + \frac{\partial^2 S}{\partial y^2})$ to describe the total amount of drug transported into the city.  describes the tendency of drug spread, i.e. the trend of transporting drug from $(x,y)$ to neighboring coordinates.
...
\begin{algorithm}[H]
	...
	\KwData{2-dimensional array denoting the drug reports in all counties}
