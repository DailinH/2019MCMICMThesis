\subsection{the Continuous Opoid Spread Model}
...
%We use $D(\frac{\partial^2 S}{\partial x^2} + \frac{\partial^2 S}{\partial y^2})$ to describe the total amount of opoid transported into the city.  describes the tendency of opoid spread, i.e. the trend of transporting opoid from $(x,y)$ to neighboring coordinates.
...
\begin{algorithm}[H]
	...
	\KwData{2-dimensional array denoting the opoid reports in all counties}
